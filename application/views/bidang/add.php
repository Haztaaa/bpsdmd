        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form action="<?= base_url('bidang/add')  ?>" method="post" class="form-horizontal">
                        <div class="row form-group">
                            <div class="col col-md-3">
                                <label for="nama_bidang" class="form-control-label">Nama Bidang</label>
                            </div>
                            <div class="col-12 col-md-9">
                                <input type="text" id="nama_bidang" name="nama_bidang" placeholder="Masukkan Nama Bidang" class="form-control">
