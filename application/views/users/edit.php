        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form action="<?= base_url('users/edit/') . $val['id_user']  ?>" method="post" class="form-horizontal">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="username" name="username" placeholder="Masukkan Username" class="form-control" value="<?= $val['username'] ?>">
